...
Proof.
  ...
  - simpl. rewrite <- IHn'. rewrite -> mult_distr. reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  - simpl. reflexivity.
  - simpl. reflexivity.
  - simpl. rewrite -> IHb'. rewrite <- plus_n_O. rewrite <- plus_n_O. simpl. rewrite -> plus_n_Sm. rewrite -> plus_n_Sm. rewrite -> plus_n_Sm. reflexivity.
Qed.
...
Theorem double_conv : forall n : nat,
...
Compute nat_to_bin (bin_to_nat (B (B Z))).
